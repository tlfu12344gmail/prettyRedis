          ...
          <div class="q-pa-md" style="margin-top: 2px;margin-bottom: 2px;">
            <div class="q-gutter-md" style="width: 100%">
              <q-input clearable v-model="searchText"
                       filled
                       placeholder="member|member*|*member*" @keydown="enterSearch">
  ...
  export default {
    ...
    mounted() {
      ...
      window['setValueData'] = (content) => {
        ...
        command.parseCmd(content.profile+":"+content.db, 'sscan', arg).then(function (data) {
          if (data.res) {
            _self.data = [];
            let members = [];
